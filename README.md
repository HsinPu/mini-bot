...
開放、輕巧、可自架的個人 AI 小精靈框架

## 簡介

OpenSprite 是一個模組化的個人 AI 助理框架，專注在「小而好改」的 personal agent 體驗，提供統一的 LLM 介面、多頻道支援、工具呼叫與長期記憶功能。

它不是一個龐大的 assistant platform，而是更像住在你 workspace 裡的小精靈：開放、可自架、容易實驗，也適合拿來做個人助理、聊天玩具與自動化原型。
